...
func (n *IntegrationNetwork) FundAccount(addr sdk.AccAddress, coins sdk.Coins) error {
	...
	if err := n.app.BankKeeper.MintCoins(ctx, TmpMintableModule, coins); err != nil {
		return err
	}

	return n.app.BankKeeper.SendCoinsFromModuleToAccount(ctx, TmpMintableModule, addr, coins)
}
