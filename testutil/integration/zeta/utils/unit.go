...
//	erc20types "github.com/zeta-chain/zetacore/x/erc20/types"
...
//
//	coin := sdk.NewCoin(config.BaseDenom, math.NewInt(TokenToMint))
...
//	}
//
//	evmosMetadata, found := network.App.BankKeeper.GetDenomMetaData(network.GetContext(), config.BaseDenom)
//	if !found {
