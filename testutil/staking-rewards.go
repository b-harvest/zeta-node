...
//	testutiltx "github.com/zeta-chain/zetacore/testutil/tx"
//	"github.com/zeta-chain/zetacore/utils"
//)
//
...
//func PrepareAccountsForDelegationRewards(t *testing.T, ctx sdk.Context, app *app.App, addr sdk.AccAddress, balance math.Int, rewards ...math.Int) (sdk.Context, error) {
...
//	err := FundModuleAccount(ctx, app.BankKeeper, distrAcc.GetName(), sdk.NewCoins(sdk.NewCoin(config.BaseDenom, totalRewards)))
//	if err != nil {
...
//		stakingHelper.Commission = stakingtypes.NewCommissionRates(zeroDec, zeroDec, zeroDec)
//		stakingHelper.Denom = config.BaseDenom
//
...
//		allocatedRewards := sdk.NewDecCoins(sdk.NewDecCoin(config.BaseDenom, reward.Mul(math.NewInt(2))))
